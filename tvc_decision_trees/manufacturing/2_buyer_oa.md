...
flowchart TD
    ...
    Q3 -- "Yes<br>feat={'seller_weaker_credit': 'true'}" --> Product1["Supplier Financing<br>feat={'is_product': 'true'}"]
    Q3 -- "No<br>feat={'seller_weaker_credit': 'false'}" --> Next["Continue to next TVC step"]
    Product1 --> End2["Buyer arranges financing program where suppliers receive early payment.<br>Buyer extends payment terms. Continue to next TVC step"]
