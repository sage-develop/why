...
# Step 2: Add attr to decision tree nodes with AI:
# - action
# - is_product
...
class Extractor:
    ...
    def extract_with_context(
        self, text: str, schema: Type[BaseModel], context: str = ""
    ) -> BaseModel:
        """
        Extract structured data from client text with decision tree context.
        """
